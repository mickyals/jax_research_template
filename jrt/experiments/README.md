...
|-----------|-------------|
| [`sparse_obs_cross_attn/`](sparse_obs_cross_attn/README.md) | Tropical cyclone intensity classifier from sparse land surface observations using a unified Transformer with asymmetric attention mask |
