"""
experiments/tc_perceiver_io/data/dataset.py
...
-----------
    ...
    label          : np.int32             class id from the TargetSpec labeller
                                          (0 = background for the default
                                          'organisation' 9-class scale)
...
from experiments.tc_perceiver_io.data.targets import TargetSpec, resolve_target
from experiments.tc_perceiver_io.data.transforms.derived import compute_derived
