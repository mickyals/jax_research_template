# tests/experiments/tc_perceiver_io/train/test_legacy_attention.py
# Tests for the VENDORED v2 attention (moved from tests/core 2026-07-17).
import pytest
import jax
import jax.numpy as jnp

from experiments.tc_perceiver_io.train.legacy_attention import (
    # mask utilities
    make_causal_mask,
    make_padding_mask,
    # modules
